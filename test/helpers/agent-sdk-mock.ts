import type {
  ...
  AgentSDKAdapter,
  TokenUsage,
} from "../../src/adapters/agent-sdk.js";
...
export interface MockInferenceProvider extends AgentSDKAdapter {
  query<T>(
    ...
    if (!configuredResponse) {
      return {
        ...
        error: {
          ...
          message: `No mock response configured for Agent SDK call ${callIndex}`,
          details: {
            callIndex,
...
const detectQueryKind = (options: AgentQueryOptions): QueryKind => {
